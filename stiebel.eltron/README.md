...
- **Identify 0xFE07.** 0xFE1B commands it and 0xFE07 measures the result,
  ...
  reading 5.6 or 5.2, which kills the assumption that it is tenths rather than
  the element itself. 0xFE09 sits in the same circuit and is the better handle
